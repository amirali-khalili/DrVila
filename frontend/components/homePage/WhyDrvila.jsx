  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center card-hover">
      <div className="w-16 h-16 rounded-full bg-[#fbf1de] mx-auto flex items-center justify-center mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-[var(--gold)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M11 17a4 4 0 0 0 8 0v-1a4 4 0 0 0 0-8h-.5"/><path d="M5 15a4 4 0 0 1 4-4h.5a4 4 0 0 0 3.9-3.1"/><path d="m7 21 3-3M14 3l3 3-3 3"/></svg>
      </div>
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center card-hover">
      <div className="w-16 h-16 rounded-full bg-[#fbf1de] mx-auto flex items-center justify-center mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-[var(--gold)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-4 4"/></svg>
      </div>
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center card-hover">
      <div className="w-16 h-16 rounded-full bg-[#fbf1de] mx-auto flex items-center justify-center mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-[var(--gold)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 22s8-4.5 8-11V5l-8-3-8 3v6c0 6.5 8 11 8 11Z"/><path d="m9 12 2 2 4-4"/></svg>
      </div>
    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center card-hover">
      <div className="w-16 h-16 rounded-full bg-[#fbf1de] mx-auto flex items-center justify-center mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 text-[var(--gold)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
      </div>
