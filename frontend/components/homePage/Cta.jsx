...
<section className="max-w-7xl mx-auto px-6 pb-20">
  <div className="relative rounded-3xl overflow-hidden min-h-[280px] flex items-center">
    <img src="https://images.unsplash.com/photo-1613490493576-7fde63acd811?q=80&w=1600&auto=format&fit=crop" className="absolute inset-0 w-full h-full object-cover" alt="ویلای شبانه"/>
    ...
    <div className="relative z-10 px-10 md:px-14 py-10 max-w-xl mr-0 ml-auto text-right">
      <h3 className="text-white text-xl md:text-2xl font-extrabold leading-relaxed">
        رویای ویلای خود را با <span className="text-[var(--gold-light)]">دکتر ویلا</span> بسازید.
      </h3>
