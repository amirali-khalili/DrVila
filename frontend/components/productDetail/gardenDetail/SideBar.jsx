...
function formatLocation(product) {
  if (product?.location_display) {
    return product.location_display;
  }
    ...
    <aside className="space-y-4 lg:sticky lg:top-6">
      <div className="rounded-2xl border border-gray-200 bg-white p-5">
        ...
        <a
          ...
          aria-label="دریافت مشاوره برای خرید باغ"
        ...
        <div className="mt-4 flex items-start gap-2 border-t border-gray-100 pt-4">
          ...
          <p className="text-[11px] leading-5 text-gray-400">
            برای بررسی وضعیت سند، بافت، انشعابات و هماهنگی
            بازدید با مشاور ملک تماس بگیرید.
          </p>
        </div>
      </div>
    </aside>
