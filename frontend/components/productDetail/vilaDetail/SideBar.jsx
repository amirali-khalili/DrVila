      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5">
        ...
        <div className="mb-5 flex items-center justify-between gap-3">
          <span className="rounded-lg bg-gray-50 px-2.5 py-1.5 text-[11px] font-medium text-gray-500">
            کد ملک: {Number(product?.id).toLocaleString("fa-IR")}
          </span>
        ...
        <div className="mb-5 border-y border-gray-100 py-4">
          <p className="mb-1 text-[11px] text-gray-400">قیمت ملک</p>
        ...
        <div className="mb-5">
          ...
          <dl className="space-y-3">
            <div className="flex items-center justify-between gap-3">
              <dt className="text-[12px] text-gray-400">تاریخ ثبت</dt>
            ...
            <div className="flex items-center justify-between gap-3">
              <dt className="text-[12px] text-gray-400">آخرین به‌روزرسانی</dt>
        ...
        <div className="mt-4 flex items-start gap-2 border-t border-gray-100 pt-4">
          ...
          <p className="text-[11px] leading-5 text-gray-400">
            برای دریافت اطلاعات تکمیلی و هماهنگی بازدید با مشاور ملک تماس
            بگیرید.
          </p>
        </div>
      </div>
