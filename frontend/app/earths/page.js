...
async function getProducts(filters) {
  ...
  const url = query ? `http://localhost:8000/api/v1/earths/?${query}` : "http://localhost:8000/api/v1/earths/";
          ...
          <section className="min-w-0">
            ...
            <div className="mb-4 lg:hidden">
              <div className="mb-3 flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">{total.toLocaleString("fa-IR")} زمین پیدا شد</p>
                </div>
              </div>
            ...
            {productItems.length === 0 ? (
              <div className="rounded-[24px] bg-white px-6 py-16 text-center shadow-soft">
                ...
                <p className="mt-2 text-sm leading-7 text-gray-500">زمینی مطابق فیلترهای انتخاب‌شده پیدا نشد؛ چند فیلتر را حذف و دوباره امتحان کنید.</p>
              </div>
