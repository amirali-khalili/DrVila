...
from .serializers import EarthSerializer
from .serializers import EarthListResponseSerializer


class EarthListAPIView(APIView):
    ...
    @extend_schema(
        summary="List earths",
        description=(
            "Get earths with filtering, sorting and pagination."
        ),
        parameters=[
            # =========================
            # Price
            ...
            OpenApiParameter(
                ...
                location=OpenApiParameter.QUERY,
                required=False,
                description="Minimum price in billion Toman.",
                examples=[
                    OpenApiExample(
                        name="5 billion",
                        value=5,
            ...
            OpenApiParameter(
                ...
                location=OpenApiParameter.QUERY,
                required=False,
                description="Maximum price in billion Toman.",
                examples=[
                    OpenApiExample(
                        name="15 billion",
                        value=15,
            ...
            OpenApiParameter(
                ...
                description=(
                    ...
                    "All selected features must exist. "
                    "Available values: "
                    "deed, caretaker, in_urban_area,has_utilities."
                ),
                examples=[
                    OpenApiExample(
                        name="Deed",
                    ...
                    OpenApiExample(
                        name="Deed and caretaker",
                        value="deed,caretaker",
                    ),
                    OpenApiExample(
                        name="Multiple features",
                        value="deed,caretaker,in_urban_area,has_utilities",
                    ),
                ],
            ),
            ...
            OpenApiParameter(
                ...
                location=OpenApiParameter.QUERY,
                required=False,
                description="Sorting method. Default: newest.",
                enum=[
                    "newest",
                    "price-asc",
                    "price-desc",
        ...
        responses={
            200: EarthListResponseSerializer,
            422: {
    ...
    def get(self, request):
        ...
        if features_param:
            ...
            # AND logic
            #
            # features=deed,caretaker
            #
            # =>
            # deed=True AND caretaker=True
